...
main_branch = 'master' # can be main
git_url_base = f'https://raw.githubusercontent.com/{git_username}/{repo_name}/{main_branch}'
...
def create_new_wishlist(args):
    ...
    wishlist_add_new(args, 1906, "Distribution and CI", '87qot8FAxuJGpuniE9JwSvJGEvJ1q2werDQdQuMKwpH26u95Qx654XChjjrAoF7j6VCSxCVjmQNidcDLSCDowx3L7S3DSND', "work")
    wishlist_add_new(args, 1906, "Ports", '86ign3TRoYhTa47hAv9WG8hUCt3UGdrLEbho65N9X9L3afQR6WPSULoJW6MjPSRdHQ9dSWUEHgGNXFaVMYEDVvdEVLP13cx', "work")
    wishlist_add_new(args, 1906, "Search algorithm", '87zTm2Womrzg16YQ4d4JfNaQRPPXhcsWHNmGXxDyS3UPiLfX8pfMf3j7sZANB2a24zRbD7TiU2QJTNafpiX2DNDwLuzuyeJ', "work")
    wishlist_add_new(args, 1906, "Modularization and enabling future work", '88yP5jmhnT27ktzvwQwWP4PPX9R1ZVC9ufr51zFhhUhVe8d5LRoMN75S1XDBna9jrGCwGM83dqF3WTYNmgZVPg1oR9F8aZf', "work")
    wishlist_add_new(args, 1906, "Electrical modeling improvement", '88jr2kFJ9R1A4rZ4DKYAEn3qZ5Xx13AWbbhXyojzQkfqdJXFRTFNPhS7c5Z6HoUBW6f4ib3J63fbgDd2fFq6M3fpVihfPU1', "work")
    wishlist_add_new(args, 1906, "Documentation", '86P4wiPd9upjSr5joqm7vPDv4r1ano85MUNNiVmTpmxYZH2hFbUCUWSXwsZkyG6GUqCa3TAebvCUtCBcWLxnMLArBx3uro8', "work")
    wishlist_add_new(args, 1906, "Minor", '84P8wpLjFHBZck2A3qGC8FBGfVe2fScBS4BXe7vZj8wgH81nX4HgrmSeXswWN8Zenp58nQPrPpZZvUvA7aWpX6qG1swTXrX', "work")
    wishlist_add_new(args, 1906, "Compare historical results", '8BCjamcpmJXFn996XkrxokREV6uRaVyhq6awJDNE5fTXSz9fSRrKDm7FfbpCuVrKZa7LhVTu8HGGvfmnhyFemit691yzVvt', "work")
    wishlist_add_new(args, 1906, "Scheduled energy production", '862CmLxEchjVvdy5WbmttqF3b9HV9NxoVYWf8tRfWrWDGg9w2VoJYdRaiUTA7bQ4LEF6adC3NJ3DeWwKHU8gSh8oPANoaik', "work")
    wishlist_add_new(args, 1906, "Detailed cloud forecast", '82kbNCQvuFpNL8dhjgHvL6DncJwviLBh4MxgHqYTtZtT5kYpwQsUiLgHxUShkVKrfCUHH79eCYtQ83L41NuufWWx2ckc5M9', "work")
    wishlist_add_new(args, 1906, "Leverage Boost Units library", '86ey42pnTgsTQLMXYqWQBfXpFw7XvU1kiP3ros4Tm5uuS5mtymyPVeGWvyVLyrXNtySBCJ5RcoUuVhZWG8KQTggpA5xTzYF', "work")
    wishlist_add_new(args, 1906, "Synthetically increasing the load", '8C1r9CfBEcaXW7C3PYfFwihAka1SK9hWuGK41XNj1R4dDmZjas4vjY5cCY9MBsi3oY5MeejbphiPQ9Z7AjhfQdcyE98s3P4', "work")
    wishlist_add_new(args, 1906, "Hashrate predictions into model ", '84VdH5WMyMVHJGUMDVVGzq1hXS5DeAmD3hooZuWDrNvUCvHcVjaUoa99GGgA2vNstyMXXXuM539qe5sPKWMgcEYe1xUF9Fi', "work")
    wishlist_add_new(args, 1906, "UIs: console + curses + Qt", '83oF1ZuPqsHGtfXGAy6gwSawu9bKT3xnAeme7bzGQnh3jgXkpmb8cNrg5WrL9Lvg5s7vpV8kcjCGNBgSi5WwVJuH5rAHY5u', "work")
    wishlist_add_new(args, 1906, "Habits dynamic UI", '8B53Gy7JGqLF6Saf477CLD4Z93Ft9Lq11a12jL6QbxsqJqMTk13hnT9TQ2nQ2Dp7THjKR42Ud9i8aRRuk6oMb8PYLZZn7NT', "work")
    wishlist_add_new(args, 1906, "Enabling crypto currencies other than XMR", '83DAC8t9AGXCfHb9HVE6pnPbxeCV8AB3VSs7YA4QC3p3QxpoFJ7J7PXFgjCYA2v1QX7WmZhEPP3gVZU7dAEH6LxWMUDhPtU', "work")
    wishlist_add_new(args, 1906, "Business model introduction", '83rhqsKQf8qLjhkVwSvVDw16KmtUPseVGWfJvCYVWSYNV6cPxhedJpiXhfvCsTaxhVfsXriRiCXxdN5xVd3JhQ97NzWDwkk', "work")
